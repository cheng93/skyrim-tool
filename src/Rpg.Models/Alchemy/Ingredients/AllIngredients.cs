...
namespace Rpg.Models.Alchemy.Ingredients
{
    ...
    {
        private static readonly List<IIngredient> privateList = new List<IIngredient>()
        {
            ...
            AllIngredients.FarengarsFrostSalt,
        ...
        public static readonly IEnumerable<IIngredient> List = new ReadOnlyCollection<IIngredient>(privateList);
    }
}